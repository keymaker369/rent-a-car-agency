...
$server->register ( "izracunaj", array ('kilometri' => 'xsd:double', 'potrosnja' => 'xsd:double' ), array ('return' => 'xsd:double' ), 'urn:potrosnja', 'urn:potrosnja' );

function izracunaj($kilometri, $potrosnja) {
	return ($potrosnja * $kilometri);
}
